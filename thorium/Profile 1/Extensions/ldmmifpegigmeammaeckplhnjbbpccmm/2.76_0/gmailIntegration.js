...
/******/ 	return __webpack_require__inject_script_fix(__webpack_require__.s = 14);
/******/ })
/************************************************************************/
/******/ ({
...
const gmail_1 = __webpack_require__(15);

function loadInboxSDK() {
  return __awaiter(this, void 0, void 0, function* () {//first is to ask background to inject script
    // await promisify(chrome.runtime.sendMessage as any, { type: 'loadInboxSDK' })
    // return new Promise((resolve)=>{
    //     InboxSDK?.load(2, 'sdk_SaveToNotion_62d1195e46', {}).then(function (sdk) {
    //         sdk.Conversations.registerMessageViewHandler(async function (
    //             messageView
    //         ) {
    //             const messageId = await messageView.getMessageIDAsync()
    //             console.log("hello world", messageId)
    //             // custom.messageView.insertSaveToNotionButton(messageView, messageId)
    //         })
    //         resolve(true)
    //     })
    // })
...
function checkCanLoadGmailIntegration() {
...
function loadCurrentEmail() {
  const x = gmail_1.Gmail;
  const gmail = window.gmailjs; // get 

  const emailId = gmail.new.get.email_id();
  console.log("hello world 2", gmail, emailId);
}
...
var Gmail = function (localJQuery) {
  ...
  window.gmailjs = new Gmail(window.$);
