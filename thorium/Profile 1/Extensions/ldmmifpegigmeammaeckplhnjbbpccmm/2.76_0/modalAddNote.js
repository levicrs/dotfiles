...
/******/ 	return __webpack_require__inject_script_fix(__webpack_require__.s = 26);
/******/ })
/************************************************************************/
/******/ ({
...
box-shadow: 0px 2px 4px -1px rgba(0,0,0,0.2),0px 4px 5px 0px rgba(0,0,0,0.14),0px 1px 10px 0px rgba(0,0,0,0.12);
    ...
    function listener(event) {
      ...
      switch (event.data.type) {
        case "SAVE_TO_NOTION_FROM_PAGE":
          console.log("Content script received: " + event.data.text); //port.postMessage(event.data.text)
  ...
  if (needAppend) document.documentElement.appendChild(modal); //hide on change
...
modalAddNote(); //sendAsyncRespToBackground(modalAddNote())
